...
import com.syy.dpms.mapper.BlogMapper;
import com.syy.dpms.service.BlogService;
...
//                .collect(Collectors.toList());
        List<UserDTO> userDTOS = (List<UserDTO>) userServiceFeignApi.queryUsersByIdsWithOrder(ids).getData();
        // 4.返回
    ...
    private void queryBlogUser(Blog blog) {
        ...
        User user = JSONObject.parseObject(JSONObject.toJSONString(userServiceFeignApi.getUserById(userId).getData()), User.class);
